...
export const Countries = () => {
  ...
  return (<><div>
    {visitedCountry.length> 0 &&  <h1 className="text-center">Total visited Country{visitedCountry.length}</h1>}
  ...
  <div className="grid grid-cols-1 mx-5 md:grid-cols-2 lg:grid-cols-4 gap-10">
    ...
    {first && first.map((el,iDx)=>{
     ...
     return <CardComponent key={iDx} name={naam} flag={flag} capital={el?.capital} handleVisitedCountry={handleVisitedCountry} />})}
